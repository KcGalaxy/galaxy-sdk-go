...
// Mongodb provides the API operation methods for making requests to
// mongodb. See this package's package overview docs
// for details on the service.
//
// Mongodb methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Mongodb client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Mongodb {
	svc := &Mongodb{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Mongodb operation and runs any
// custom request initialization.
func (c *Mongodb) newRequest(op *request.Operation, params, data interface{}) *request.Request {
