...
// Slb provides the API operation methods for making requests to
// slb. See this package's package overview docs
// for details on the service.
//
// Slb methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Slb client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Slb {
	svc := &Slb{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Slb operation and runs any
// custom request initialization.
func (c *Slb) newRequest(op *request.Operation, params, data interface{}) *request.Request {
