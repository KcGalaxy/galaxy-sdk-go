...
// kce. See this package's package overview docs
// for details on the service.
//
// Kce methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Kce client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Kce {
	svc := &Kce{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Kce operation and runs any
// custom request initialization.
func (c *Kce) newRequest(op *request.Operation, params, data interface{}) *request.Request {
