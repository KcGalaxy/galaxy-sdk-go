...
// Sks provides the API operation methods for making requests to
// sks. See this package's package overview docs
// for details on the service.
//
// Sks methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Sks client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Sks {
	svc := &Sks{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Sks operation and runs any
// custom request initialization.
func (c *Sks) newRequest(op *request.Operation, params, data interface{}) *request.Request {
