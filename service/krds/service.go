...
// Krds provides the API operation methods for making requests to
// krds. See this package's package overview docs
// for details on the service.
//
// Krds methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Krds client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Krds {
	svc := &Krds{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Krds operation and runs any
// custom request initialization.
func (c *Krds) newRequest(op *request.Operation, params, data interface{}) *request.Request {
